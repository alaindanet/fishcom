...
# Mat generated by willem's code
...
metaweb <- build_metaweb(
  ...
  fish_resource_method = "willem",
  na.rm = TRUE,
  replace_min_by_one = TRUE)
...
# Bonus code of Willem, I guess that it is for cpp program:
