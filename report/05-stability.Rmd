...
plot_grid(plotlist = plot_stab[7:8], ncol = 2)
```
...
```{r 25-stab-troph, fig.dim = c(10, 7), fig.cap = "Four stations with medium/low biomass stability. See caption of Figure for details."}
# Third quater
...
```{r abun-sp, fig.cap = "Species most abundant by trophic group."}
