...
habitat_sem <- habitat_pressure %>% 
  select(station, alt, width_river_mean) %>%
...
```{r, fig.cap = "The basic SEM"}
  corsem <- psem(
    lme(log_sync ~ log_rich + piel + alt + c_c + t_lvl + beta_bin_c, random = ~ 1 | basin, data = lav_data),
    lme(log_cv_sp ~ log_rich + piel + c_c + t_lvl + beta_bin_c, random = ~ 1 | basin, data = lav_data),
    lme(log_rich ~ alt + width, random = ~ 1 | basin, data = lav_data),
    lme(piel ~ alt + width, random = ~ 1 | basin, data = lav_data),
    lme(c_c ~ alt + width, random = ~ 1 | basin, data = lav_data),
    lme(t_lvl ~ alt + width, random = ~ 1 | basin, data = lav_data),
    lme(beta_bin_c ~ alt + width, random = ~ 1 | basin, data = lav_data),
    lm(log_stab ~ log_cv_sp + log_sync, data = lav_data)
  )
...
compute_psem <- function(.data) {
  corsem <- psem(
    lme(log_sync ~ log_rich + piel + alt + c_c + t_lvl + beta_bin_c + MDS2, random = ~ 1 | basin, data = .data),
    lme(log_cv_sp ~ log_rich + piel + c_c + t_lvl + beta_bin_c + MDS2, random = ~ 1 | basin, data = .data),
    lme(log_rich ~ alt + width, random = ~ 1 | basin, data = .data),
    lme(MDS2 ~ alt + width, random = ~ 1 | basin, data = .data),
    lme(piel ~ alt + width, random = ~ 1 | basin, data = .data),
    lme(c_c ~ alt + width, random = ~ 1 | basin, data = .data),
    lme(t_lvl ~ alt + width, random = ~ 1 | basin, data = .data),
    lme(beta_bin_c ~ alt + width, random = ~ 1 | basin, data = .data),
...
```{r}
lav_data %>%
  ggplot(aes(x = log_rich, y = MDS1)) +
  geom_point() +
  labs(x = "Log of species richness", y = "Axis of composition")
...
```{r, fig.cap = "Biomass"}
prod_sem <- psem(
  lme(prod ~ log_rich + piel + c_c + t_lvl + beta_bin_c + MDS2, random = ~ 1 | basin, data = lav_data),
  lme(MDS2 ~ alt + width, random = ~ 1 | basin, data = lav_data),
  lme(log_rich ~ alt + width, random = ~ 1 | basin, data = lav_data),
  lme(piel ~ alt + width, random = ~ 1 | basin, data = lav_data),
  lme(c_c ~ alt + width, random = ~ 1 | basin, data = lav_data),
  lme(t_lvl ~ alt + width, random = ~ 1 | basin, data = lav_data),
...
```{r colin_prod}
car::vif(lme(prod ~ log_rich + piel + c_c + t_lvl + beta_bin_c + MDS2, random = ~ 1 | basin, data = lav_data))
```
