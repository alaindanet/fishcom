...
hab_type <- na.omit(habitat_pressure) %>%
...
hab_type_pca <- hab_type[hab_type$station %in% na.omit(habitat_pressure)$station, ]
match_st <- match(hab_type_pca$station, na.omit(habitat_pressure)$station)
