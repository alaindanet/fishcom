...
These models show that both complementarity in the use of resources and selection effects,
...
Despite these theoretical evidence that structure affects biomass, we are
...
Several theoretical studies considering a single trophic level have
...
expected to increase with the variability of species responses to perturbations. Though most
...
@jacob_productivity_2010; @seidel_relationship_2013] and marine fishes [@maureaud_biodiversityecosystem_2019]. Some authors suggest that
the lack of resource complementarity, environmental harshness or past human
pressures might be responsible for negligible, or negative effects of species
richness [@loreau_biodiversity_2001; @he_global_2013; @wu_relationship_2015;
...
thereby, species abundances, total biomass [@grace_integrative_2016; @woods_testing_2020] and temporal
