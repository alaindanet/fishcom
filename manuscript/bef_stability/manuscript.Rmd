...
X million individual fish samples, across 99 locations France spanning the
period 1995 to 2018.  We infered trophic interactions networks based on body
size-dependency in food diet from the literature and prey/predator body size
...
or might be due to positive select effect which takes place through the
dominance of the most productive species [@tilman_plant_1997;
@loreau_partitioning_2001]. Previous research seems to indicate that resource
complementarity might be the main driver in fish communities
[@carey_determining_2011] but futher invesgations are needed to assess the
dominance of this mecanism in aquatic communities and more generally in food
webs. 
...
to identify the mechanisms behind those contrasting patterns. A first step is 
be to look at the effects of species richness on synchrony and
$\overline{CV_{sp}}$, which constitute the two components of temporal stability
quantified as CV [@loreau_species_2008; @thibaut_understanding_2013].

We found that species richness decreases synchrony, thereby increasing
stability. Species richness can reduce synchrony through decrease of population
size, thus raising the role of demographic stochasticity [@loreau_species_2008]
but also in the case where species have different responses to environmental
variation [@loreau_species_2008]. While
a negative effect of species richness on synchrony is generally found in
experimental grasslands [@isbell_biodiversity_2009; @roscher_identifying_2011],
no relation has been found in natural forests [@declerck_species_2006], but
negative relationships have been found in natural communities of birds, bats,
grasslands, bats and butterflies [@bluthgen_land_2016;
@olivier_independent_nodate]. Our study thus highlights that species richness
might also decrease synchrony in empirical trophic communities.   

Whereas the positive effect of species richness on $\overline{CV_{sp}}$, thereby
decreasing stability, was more intriguing. Indeed, precedent studies found that
constrasting results. For example, @olivier_independent_nodate reported negative, neutral and
positive effect of species richness on $\overline{CV_{sp}}$ in respectively
butterfly, bat and birds communities. @thibaut_understanding_2013 proposed that
two ingredients can generate a positive effect of species richness on
population ($\overline{CV_{sp}}$) stability: a strongly uneven biomass
distribution across populationand that the biomass variance
of population increases much faster than its mean.
...
trophic levels. @shanafelt_stability_nodate and @barbier_pyramids_2019
...
In
trophic communities,  additionnaly to the **portefolio effect**, the importance
of trophic interactions on synchrony (mal dit).
