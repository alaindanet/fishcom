...
com_data <- compute_community_temporal_analysis(.op = op_analysis, dest_dir = mypath("data", "classes"))
...
library(DiagrammeR)
graph <- build_diag_from_sem(stab_sem_rich, p_val_thd = 0.05)
