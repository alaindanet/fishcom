...
Both the relationship between diversity and ecosystem functioning, and between food
...
species richness, food web structure and annual biomass and its temporal stability
...
positive relationship with annual biomass of fish communities while they had
respectively a negative and positive effect on its temporal stability. We
also found that the effects of stream size and temperature on annual biomass and
...
effects of food web structure. Theoretical models have recently moved from
...
lacking empirical studies that assess jointly how food web structure and species
...
for food web structure, even more so than the relationship between diversity and
biomass production. 
...
food web structure is expected to strongly affect the stability of communities
...
between food web complexity and stability in ecology, we still have very few
...
Our aim is to document the relationships among species richness, food web structure, 
...
matmet_cap <- paste0(
  ...
  "Yearly temporal series of networks of two stations having respectively a low (A) and high
  (B) temporal stability of biomass. A and B stations have respectively the
  closest stability to the first and third quartile of the distribution of the
  temporal stability of biomass in the dataset. Point size are proportional to
  the biomass of the trophic species.  (C) Observation sites (black dots) were
  located across France and monitored on the period 1995-2018. ", "Grey shades
  highlighted elevalation variation. ", "Inner borders draw the limits of the
  hydrographic basins. ", "(D) The metaweb. Each trophic species (N = 412) is
  represented by a node and each color represent a species (S = 45). Resource
  nodes (7) were drawn in grey. ", "The species names corresponding to the three
  digit codes are found in Table SXX."
)
```
...
sem_caption <- paste0(
  ...
  paths (i.e, *P < 0.05*) are shown. Rsq: Ajusted R square."
...
caption_sem <- paste0(
  ...
  "As an example, the indirect effect via species richness takes into account
 the direct effect of species richness as well as the effect of species richness
 through connectance and average trophic level. ",
...
network structure. It is the first direct assessment of a possible joint effect of
...
pathways had not been evidenced to jointly play, as far as we know.
