...
affected in turn. Since 1970s, ecology aims to uncover the complex relationships
between biodiversity and ecosystem properties [@may_will_1972; @hector_plant_1999;
@loreau_biodiversity_2001; @hooper_effects_2005; @duffy_why_2009;
@isbell_forest_quantifying_2018]. Because biodiversity largely determines in
turn both quantity and distribution of biomass or energy across ecosystems, it
has a tremendous effects on the properties exhibited by an ecosystem, such as
its size (total biomass) [REF], its production (production of biomass by units of
time) [REF] and the temporal stability of its biomass [REF].
...
species richness [REF] and in number of functional groups, i.e species are
gathered on what they do [REF]. Those metrics can be gathered into "horizontal
diversity", describing the list of components present in a community. An
...
they are distributed among species. The latter can be quantified as the number
...
are, however, not independent from each other [@zhao_horizontal_2019]. The add
or removal of one species can have different effects depending on its vertical
position in the trophic chain [REF duffy 2007]. Hence, it is crucial to
study their interplay to increase our understanding of ecosystem dynamics. 
...
[@tilman_productivity_1996; @cardinale_resource_2001; @grace_integrative_2016].
...
translate into increase in plant biomass  through
resource complementarity [@loreau_biodiversity_1998] and selection effects [@tilman_plant_1997]. The
...
amount of biomass is transfered to consumers. It has been shown both in
experiments [REF] and theoretical models [@thebault_food-web_2003]. Futhermore,
at higher trophic level, the resource complementary of consumers can increase as
the number of consumer species increase [@thebault_food-web_2003]. However, the
joint effects of horizontal and vertical diversity on total biomass has been
rarely tested. It is not clear whether horizontal and vertical diversity just
change the distribution of biomass across trophic level or it increases the
total amount of  biomass.

One reason might be the focus on plant communities, which are relatively easy to
manipulate and have an important role on determining the quantity and quality of
biomass for the other compartments of ecosystems [REF]. One trophic level is
often considered, and so the comp
...
#### Horizontal and vertical diversity stability

Horizontal and vertical diversity also affects the stability of ecosytem
properties. Experimental studies showed consistently that species richness
increase temporal biomass stability in grasslands [@tilman_biodiversity_2006],
mesocosms [@pennekamp_biodiversity_2018]. While in natural communities,
same relation has been found for temporal biomass stability in stream fish communities 
[@franssen_annual_2011] and temporal abundance stability of birds and butterfies
[@olivier_independent_nodate, but not bats]. Two mecanisms are involved into
temporal stability of communities, (1) synchrony and (2) variability
[@loreau_species_2008; @thibaut_understanding_2013]. Synchrony mesures the
covariation of species through time. Very low synchrony indicates compensatory
temporal variation between species and so increased temporal stability. studies
consistently found that species richness decreased synchrony between species
[@loreau_species_2008; @thibaut_understanding_2013; @bluthgen_land_2016;
@olivier_independent_nodate]. (*Should I add more details about the
mecanisms?*). The average temporal variability of species is measured as a
average coefficient of variation of species, weighted by species
...
species variability and species richness have been found. Hence, synchrony
has been found to be the main driver of temporal
stability [@tilman_biodiversity_2006; @olivier_independent_nodate] and
responsible for the positive relationship between horizontal diversity and
temporal stability of biomass and abundance.

Vertical diversity, represented by network structure, has been central to the
the literature of diversity-stability debate and largely explored by theoretical
...
on stability notably through its effects on the propagation of perturbation.
...
small perturbations [@may_will_1972; @angelis_stability_1975;
@barbier_pyramids_2019; @shanafelt_david_w._stability_nodate] or to the number
of secondary extinctions of perturbation [@duffy_why_2009]. Those stability 
metrics harly relates to empirical temporal stability [see
@arnoldi_resilience_2016]. However, the work of @thebault_trophic_2005 shows
that asynchrony consistenly increase temporal stability and the positive
relationship between temporal stability and species richness. However asynchrony
can also increase species variability through interspecic competition, which
amplifies species fluctuations. Furthermore species interactions, considered as 
as competition strength and niche breath of consumers can results in negative or
positive temporal stability-species richness relationships
[@thebault_trophic_2005]. Vertical diversity, as network structure, can have
strong effects on temporal stability. However, there are few assesments of the
effects of horizontal and diversity on temporal stability in natural
communities.

#### Stream fish communities is a good model to study effects of horizontal & vertical diversity

Stream fish communities constitutes good model to study the joint effects of
horizontal & vertical diversity on total biomass and the temporal stability of
biomass. Despite that fish trophic interactions are not recorded in nature, a
consequent body of litterature supports that they can be infered through body
size and diet informations [@gravel_inferring_2013; @jennings_weak_2001;
@brose_predator_2019]. Most of the biomass-diversity and
stability-diversity relationships have been assessed in terrestrial ecosytems
while there is a evident need to test such relationships in a variety of
ecosystem types. Stream ecosystems are caracterized by the flowing water and
depends for the large part from the input of terrestrial ecosystems
. Furthermore, the biotic activity in stream ecosystems
determines for a large part the water quality [@cummins_structure_1974] and thus  
are crucial to maintain **human selfish goals (I can do better than that)**.
...
stability [@de-boeck_patterns_2017; @hansen_climate_2013; @bluthgen_land_2016;
@oliver_heterogeneous_2010; @fried-peterson_drivers_2020]. Hydrology of streams
...
#### SEM is perfect and our metamodel too 

To reveal the direct and indirect effects of environment, horizontal & vertical
diversity on both total biomass and its temporal stability, we used Structural
Equation Modeling (SEM). It is one promising way to go beyond bivarite
relationships and to investigate complex relationships, direct and indirect,
between variables  [@grace_structural_2008; @grace_causal_2014;
...
the links between them.  Therefore, the set of variables and links shoud be
supported by theory and litterature. We built a metamodel (set of variables and
links between them). Basically, we tested the links between environmental
conditions, horizontal & vertical diversity and both total biomass and its temporal
stability (Figure \@ref(fig:matmet) A). We considered that environment can
directly affect horizontal and vertical diversity, as well as total biomass and
its temporal stability. Horizontal diversity, measured as species richness
directly affects vertical diversity, total biomass and
its temporal stability. Food web structure was shown to be constrained by
species richness. In turn vertical diversity affects total biomass and
its temporal stability (Figure \@ref(fig:matmet) A). Two other questions can
only be answered when considering both direct & indirect relationships. (1) What
is the magnitude of environmental effects on total biomass and
its temporal stability compared to horizontal and vertical diversity? (2) Which
is the pathway of environment, horizontal & vertical diversity on total biomass
and its temporal stability ? (2a) For environment, is it mainly (i) direct,
indirect (ii) through horizontal diversity, (iii) through horizontal & vertical
diversity or (iv) indirect through only vertical diversity? (2b) For horizontal
diversity, is it mainly (i) direct, or (ii) indirect through vertical diversity?
Finally for temporal stability, how do environement, horizontal & vertical
diversity affect synchrony & species stability ?
...
(**XXX**) potential interaction networks corresponding to each sampling event,
based on trait matching. Horizontal diversity was measured as species richness
while vertical diversity was as connectance and average trophic level.
Environment was characterized by the stream size, temperature, flow,
enrichment, altitude and their stability (expect for altitude). Finally total
