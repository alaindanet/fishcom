...
stability. We found that species richness and average trophic level had a positive
...
average trophic level are not independent and that environment had a tremendous
effect on total biomass and its temporal stability notably through its effect on
species richness and average trophic level. Our study highlights that the effects of
species richness and average trophic level should be assessed conjointly and that it
...
and taxons. Indeed species richness generally increases primary productivity
...
@olivier_urbanization_2020]. Increasing, respectively decreasing, species
variability results in respectively a decrease and an increase of temporal
stability [@thibaut_understanding_2013]. Positive relationships between species
variability and species richness have been observed in experimental grasslands
[@tilman_biodiversity_2006], thereby decreasing stability. However, positive,
neutral and negative relationships have been found in natural settings
[@thibaut_understanding_2013; @olivier_urbanization_2020]. ^[Colin asked for a
word about $cv_{sp}$ and stability but my opinion is that it
is not necessary and that the depth of mecanisms are currently fairly explained
for the introduction.] Overall, positive relationships between species richness and
temporal stability are also observed in natural settings, such as stream fish communities
[@franssen_annual_2011], bird and butterfly communities
[@olivier_urbanization_2020].
...
comparison of the strength of the effects of environment and community
...
Because their trophic interactions can be infered, stream fish community
...
Our study aims to document the relationships between foodweb structure and total
biomass and its temporal stability in natural communities. To do so, we used the
ONEMA dataset consisting in standardized sampling of fish communities in French
streams [@edeline_ecological_2013]. 99 sites were sampled for more than 10 years
spanning on the 1995-2018 period. We inferred 1496 interaction networks, based
on body size and food diet. We question whether species richness, connectance
and average trophic level increase, decrease or are not related to total biomass
and its temporal stability. We further question whether the species richness,
connectance and average trophic level have antagonistic or synergistic effect on
total biomass and its temporal stability. Finally, we question if 
ecosystem size and average temperature increase total biomass and its temporal
stability. 
...
#for more than 10 years spanning on the 1995-2018 period. We inferred 1496
#interaction networks, based on body size and food diet. The network structure
#was summarized by connectance and mean trophic level. Environment was
#characterized by stream size, altitude, slope, temperature, flow and enrichment.
#Finally total biomass was measured as median total biomass over the sampling
#period while its temporal stability was quantified as the inverse of the CV.
#
...
meta-analyses [@lleonart_removing_2000; @froese_cube_2006]. Species biomass and
total biomass at each sampling event was then calculated by summing individual body
masses. To account for the variation in sampling effort among sites, species
biomass and total biomass have been related to the surface sampled, i.e.
$gm^{-2}$. In the further analysis, the total biomass of a station has been
defined as the median of the total biomass over time.
...
over lifespan and thereby over body size. For example, alvins feed on plankton while adults may feed on
algae, fishes, with bigger individuals eating bigger fishes. Each
fish species was hence divided in nine body size classes, each corresponding to a
trophic species (Figure S2), thereby increasing the accuracy of trophic
interactions inference [@jennings_weak_2001]. HERE
...
biomass (Figure \@ref(fig:sem-plot) B). 
...
total biomass (Figure \@ref(fig:sem-plot) B). In addition,
...
@loreau_partitioning_2001] or might be due to a positive selection effect
[@tilman_plant_1997; @loreau_partitioning_2001], which leads to the dominance of
the most productive species. The study of @carey_determining_2011 showed that
resource complementarity might be the main driver in fish communities.
...
## Mean trophic level increased total biomass and its temporal stability

The mean trophic level was positively linked to total biomass. As feeding
interactions were partly determined by body size and that body mass increase
with body size, it is expected that the more the average
...
We found that species richness was negatively related to mean trophic level and 
connectance [@winemiller_must_1989; @dunne_network_2006; @thebault_stability_2010]. In
...
trophic chain [@barbier_pyramids_2019; @shanafelt_stability_2018] but it is not
...
@neutel_reconciling_2007]. 

We found that connectance had no effect on temporal
stability. This result previous precedent theoretical studies on the
relationship between stability and network structure [@angelis_stability_1975;
@may_will_1972; @thebault_stability_2010], although they considered different
stability concepts and metrics [@arnoldi_resilience_2016].  Furthermore, we did
not information about the interaction strength. Indeed, interaction strength is
a crucial ingredient of stability [@may_will_1972; @angelis_stability_1975;
@dunne_network_2006]. An alternative explanation can be that connectance
increases inhomogeneously in the food web, for instance a higher connectance in
lower trophic levels will not have the stabilising effects conferred by higher
predation and omnivory in higher trophic levels. Further investigations on this
effect is needed. 
...
well known in biogeography and in freshwater communities [@allan_stream_2007;
@ogorman_chapter_2012; @emmrich_geographical_2014].  Further in line with this
...
food webs in wider streams, are also larger, and hence support more species and
biomass [@allan_stream_2007]. Greater ecosystem size might be linked to a
greater diversity of resources through habitat heterogeneity, on so higher
species richness and total biomass by surface unit, through resource
complementarity. Greater diversity of resources might also allow to maintain
higher biomass in high trophic level [@post_ecosystem_2000; @doi_resource_2009].
Overall, our results indicate that environmental effects on total biomass
operate primarily through changes in community structure. Furthermore, the
positive effect of temperature on total biomass was of the magnitude of effects
of network structure and species richness. This adds to the mounting body of
work reporting important effects of temperature on the structure and biomass of
aquatic system [e.g.  @dossena_warming_2012; @edeline_ecological_2013;
...
and its temporal stability. Species richness had a direct positive and negative effect
respectively on total biomass and its stability but a negative and positive
effect through mean trophic level. It indicates the importance to consider both
species richness, network structure and their dependence. It calls for further
investigations on how species diversity variation translates in network
structure. Our work opens a promising way for the understanding on
