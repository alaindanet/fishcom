...
synchrony. The balance between both effects is governed by the balance in the
variation in population variability and synchrony among communities, this
because we used standardised coefficients (see methods). Such an effect of
population variability on community stability twice as strong as the one of
synchrony is expected from the mathematical relation between these three
variables. This indicates that the variability of population variability and
synchrony among the studied communities are equivalent (Eq. \@ref(eq:stab)).
This result contrasts with previous findings on terrestrial animal communities
showing a variability in population synchrony twice as strong as the one of
population variability [@olivier_urbanization_2020]. Such difference in the
relative variability of population stability and synchrony between studies might
be related to the multitrophic structure of the dataset as theory predicts
...
evenness decreasing the range of variation in synchrony among communities and thereby
the strength of the portfolio effect [@doak_statistical_1998;
...
more studies are needed to understand how the relative importance of synchrony
and population variability for community stability varies among ecosystems.
