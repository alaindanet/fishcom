...
Biodiversity is a key to determine ecosystem properties
...
the seminal of paper of @may_will_1972, the relationships between
biodiversity and ecosystem properties have received a lot of attention [@hector_plant_1999;
...
determines both the quantity and the distribution of matter and energy across
ecosystems, it has a tremendous effect on the properties exhibited by an
...
gathered on what they do [@tilman_biodiversity_2014]. Those metrics can be
gathered into "horizontal diversity", describing the list of components present
in a community, i.e. here species and functional groups. An orthogonal
perspective, based on trophic chains, described species on what they eat. It can
be defined as interactions (or biomass/energy fluxes) between species and how
they are distributed among communities. It can be quantified as the number of
interaction between species or the number of trophic level. This orthogonal view
of seeing biodiversity, can be gathered into "vertical diversity". Horizontal
and vertical diversity are, however, not independent from each other
[@duffy_functional_2007; @zhao_horizontal_2019]. The add or removal of one
species can have different effects depending on its vertical position in the
...
production in a variety of ecosystems. Horizontal diversity, as species
richness, has been reported to increase productivity through complementarity
between species in resource exploitation and selection effects in plant
communities [@tilman_productivity_1996; @cardinale_species_2002;
@grace_integrative_2016].  Regarding total biomass, empirical assessment have
...
Theoretical models have also confirmed that an increase in horizontal diversity
should translate into increase in plant biomass through resource complementarity
...
amount of biomass is transfered to consumers [@thebault_food-web_2003]. It has
been shown both in experiments [REF] and theoretical models
[@thebault_food-web_2003].  @thebault_relationship_2006 have shown with a
theoretical model that total biomass should increase with the increase species
diversity at two trophic level. However, the joint effects of horizontal and
vertical diversity on total biomass has been rarely tested, especially in
natural communities. It is not clear whether horizontal and vertical diversity
just change the distribution of biomass across trophic level or it increases the
