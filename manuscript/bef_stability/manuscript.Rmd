...
[@neutel__2007]. Furthermore, competition strength and niche breath of
...
[@neutel__2007].  However, it is important to note that theoretical ecology
...
abundances and total biomass [Add general ref; @grace_integrative_2016] and
...
[@franssen_annual_2011].  Temperature has potentially conflicting effects on
horizontal and vertical diversity, as higher temperature favour primary
production and fluxes of biomass [@dossena__2012; @ogorman__2012], thus
potentially supporting more species and trophic levels [@arim__2007;
@stegen__2012], but selects against larger body sized individuals
[@dossena__2012; @edeline__2013; @hattab__2016], and thereby should reduce
trophic diversity [@hattab__2016]. It is thus unclear whether these temperature
effects translate indirectly into changes in total standing biomass and
stability in natural food webs. The relative strength of direct and indirect
effects of environment on total biomass and its temporal stability remains an
open question.

- TODO Add on ecosystem size (cf elisa)
...
communities in french streams [@edeline__2013]. 99 sites were sampled for more
...
@edeline__2013]. Two different standardized protocols were used for little and
...
*Look at Digel et al. 2011, Riede et al. 2011*
