...
Experimental and theoretical work suggested that a higher trophic level can be the
...
@hattab_forecasting_2016; @woods_testing_2020]. Contrasting with previous studies in experimental
plant communities [@grace_integrative_2016], aquatic mesocosms [@yvondurocher_warming_2011; @dossena_warming_2012] and marine fish communities [@maureaud_biodiversityecosystem_2019]
, we found that environmental drivers overall affect total biomass indirectly
rather than directly [@woods_testing_2020].
