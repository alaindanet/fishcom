...
productivity
and species richness, while species richness effect can also rise from the
statistical probability to end up with a highly productive species . The
relationship between species richness and stability is even more complex
...
richness increased community stability in grasslands [@tilman_biodiversity_2006],
mesocosms [@pennekamp_biodiversity_2018] and vertebrates
[@olivier_independent_nodate, @franssen_annual_2011]. Two components can
explain variation of community stability, (1) individual species stability and (2)
the species synchrony [@loreau_species_2008, @thibaut_understanding_2013].
Positive [@tilman_biodiversity_2006], neutral [@jiang_different_2009, @olivier_independent_nodate]
and negative [@franssen_annual_2011, @olivier_independent_nodate] relationships
between species stability and species richness have been found.
On the other side, studies consistently found that species richness decreased
