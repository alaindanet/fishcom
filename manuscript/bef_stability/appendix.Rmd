...
sem_data %>%
  select(log_bm_std, log_rich_tot_std, log_sync, log_stab_std, log_cv_sp, log_RC1, log_RC2, t_lvl, ct, log_bm) %>%
...
```{r mod-res, fig.height = 7, fig.cap = caption_mod_res}
library(nlme)
