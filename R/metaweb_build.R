...
#'
#' @param species
#' @param prey_size a data.frame generated by compute_prey_size 
#' @param fish_diet_shift a data.frame containing species, life stage, min and
#' maximum size for each stage
#' @param min variable containing lower limit of the stage 
#' @param max variable containing upper limit of the stage
#' @param fish logical does this life stage eat fish 
#'
#' @return a data.frame
compute_piscivory <- function (species, prey_size, fish_diet_shift, lower, upper, fish) {
