...
other methods. For the *complete* operation, we kept only the operation which
have two passages.
...
One idea: if the length of the transect is *constant*. For each station, we compute the residuals of
the relation between sampled area and the width of the river
