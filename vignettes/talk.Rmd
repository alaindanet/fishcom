...
mod <- lm(biomass_stab ~ troph_group*richness_avg, net_troph_group)
car::vif(mod)

coefs <- mod$coefficients
# Effect of troph group
coefs["troph_group3"]/coefs["(Intercept)"]
# Effect of richness in low troph group
coefs["richness_avg"]/coefs["(Intercept)"]
coefs["richness_avg"]*10/(coefs["(Intercept)"] + coefs["richness_avg"])
# Effect of richness in high troph group
(coefs["richness_avg"] + coefs["troph_group3:richness_avg"])/(coefs["(Intercept)"] + coefs["troph_group3"])
(coefs["richness_avg"] + coefs["troph_group3:richness_avg"])*10/(coefs["(Intercept)"] + coefs["richness_avg"]+ coefs["troph_group3"])
