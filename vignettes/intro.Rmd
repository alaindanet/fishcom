...
- [ ] Re-run willem analysis
  - [ ] Function structure:
    ...
    - [x] network methods:
      ...
      - [ ] beautiful plots
	- [ ] colored node by species
	- [ ] node size according to biomass 
	  - [ ] compute biomass by node
      - [ ] nestedness, trophic length, modularity, trophic group:
	- [ ] nestedness: Bastolla et al. (2009): should compute it 
	- [ ] trophic length: netIndices
	- [ ] modularity: igraph
	- [ ] trophic group: NetIndices?
    - [ ] network analysis:
