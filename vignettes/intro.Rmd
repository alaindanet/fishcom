...
- [ ] Analysis:
  - [ ] CV by trophic group in the two types of networks 
  - [ ] Dig in the cv versus richness relationship by trophic group
  - [ ] Productivity-diversity relationship
  - [x] Distance to source and river caracteristics
  - [x] Model by basin
  - [ ] Produce a coherent html document with logic structure
