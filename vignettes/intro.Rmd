...
- [ ] Environmental data
  - [ ] temporal flow and enrichment (Marie Silvestre): 
    - [ ] Return interesting stations
      - [ ] Buffer method around station
    - [ ] Interpolation toward the station:
      - [ ] Use RHT https://www.irstea.fr/fr/rht
  - [ ] How to analyze qualitave data:
    - [ ] Habitat
  - [ ] Pressure data (Olivier Dezerald & Philippe Usseglio-Polatera):
  - [ ] Temperature data?
