...
- [ ] Analysis:
  - [ ] generate clean subsets of data:
    ...
    - [ ] non overlapping / without holes
    - [ ] overlapping / with holes
    - [ ] non overlapping / with holes
  - [x] CV by trophic group in the two types of networks 
  - [x] Dig in the cv versus richness relationship by trophic group
  - [x] Productivity-diversity relationship
  - [x] Distance to source and river characteristics
  - [x] Model by basin
  - [x] Produce a coherent html document with logic structure
  - [x] stab div by habitat type
