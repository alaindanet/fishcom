...
myload(community_metrics, synchrony, temporal_press_polluants,
  temporal_evt_press, temporal_community_metrics, op_analysis,
  dir = mypath("data"))
...
#library("PearsonDS")
#moments <- c(mean = 3.3,variance = .2,skewness = -0.7, kurtosis = 1.75)
#rpearson(10, moments = moments)
#plot(function(x) dpearson(x, moments), -4.5, 4.5)
