...
```{r}
point_group %<>%
  filter(grp_tgp_id == "standards" & nb_pt_berge == grp_nombre)
```
...
mysave(fish_lot, elementary_sampling, dir = mypath("data-raw","fishing_op_build"))
```
